...
import com.vovavika.game.Leaderboards;
...
public class LeaderboardsPanel extends GuiPanel{
    ...
    private int buttonWidth = 100; // ширина кнопки
    ...
    private String title = "Leaderboards";  // загаловок
    private Font titleFont = Game.main.deriveFont(48f);  // шрифт заголовка
    private Font scoreFont = Game.main.deriveFont(30f);  // шрифт результатов
    ...
    public LeaderboardsPanel(){
        ...
        GuiButton tileButton = new GuiButton(300, buttonY, buttonWidth, buttonHeight);
